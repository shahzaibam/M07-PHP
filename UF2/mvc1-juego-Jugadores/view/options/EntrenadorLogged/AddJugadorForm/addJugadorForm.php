    ...
    <form method="post" action="">
        <fieldset>
            <div>
                ...
                <input type="text" placeholder="numCamiseta" name="numCamiseta" id="numCamiseta"/>

                <label for="fNacimiento" class="fNacimiento">Fecha de Nacimiento</label>
                <input type="text" placeholder="fNacimiento" name="fNacimiento" id="fNacimiento"/>

                <label for="rol" class="rol">Rol</label>
                <input type="text" placeholder="rol" name="rol" id="rol"/>

                <label for="goles" class="goles">Goles</label>
                <input type="text" placeholder="goles" name="goles" id="goles"/>

                <label for="partidos" class="partidos">Partidos</label>
                <input type="text" placeholder="partidos" name="partidos" id="partidos"/>
