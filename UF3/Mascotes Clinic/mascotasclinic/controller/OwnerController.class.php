...
require_once "model/persist/OwnerDAO.class.php"; // This controller needs to be able to access the Owners in the database.
require_once "model/persist/PetDAO.class.php";  // This controller needs to be able to access the Pets in the database (action search_pet_by_owner).
require_once "model/Owner.class.php"; // This controller needs to be able to instantiate/getParam/setParam of Owners.

require_once "util/OwnerMessage.class.php"; // This controller will display info/error messages to the user.
require_once "util/OwnerFormValidation.class.php"; // This controller needs to be able to validate user input data for inserting/updating Owners in the database.
...
class OwnerController implements ControllerInterface
{
    ...
    */
    ...
    {
        // VALIDATE ITEM
        $item = OwnerFormValidation::checkData($_POST["nif"], $_POST["name"], $_POST["email"], $_POST["phone"]);
